...
The code is targetted at the 128K Spectrum. It could work on the Next by changing the logical to physical mapping table. For larger than 64K ramdisk the addressing would need to be extended
